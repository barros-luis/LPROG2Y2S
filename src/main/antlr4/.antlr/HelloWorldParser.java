...
public class HelloWorldParser extends Parser {
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public TerminalNode WORLD() { return getToken(HelloWorldParser.WORLD, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof HelloWorldListener ) ((HelloWorldListener)listener).enterProgram(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof HelloWorldListener ) ((HelloWorldListener)listener).exitProgram(this);
		}
	}
